...
namespace UnityEngine.XR.Hands.Samples.GestureSample
{
    ...
    public class StaticHandGesture : MonoBehaviour
    {
        ...
        //All Background commented out for simplicity. Can comment back in for debugging in HandGestures Scene 
        //[SerializeField]
        ...
        /// </summary>
        /// 
        //All background will be commented out for usage, uncomment for debugging and visuliziation for HandGestures Scene
